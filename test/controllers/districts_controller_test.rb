...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { ballot: @district.ballot, invalid_vote: @district.invalid_vote, number: @district.number, voter: @district.voter }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { ballot: @district.ballot, invalid_vote: @district.invalid_vote, number: @district.number, voter: @district.voter }
    assert_redirected_to district_path(assigns(:district))
  end
